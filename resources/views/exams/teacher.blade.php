...
@section('content')
    ...
    <div id="page-container">
        ...
        <div class="mainpanel">
            ...
            <div class="contentpanel">
                <div class="panel-body">
                    <form method="POST" action="/exams/{{ $id }}/teacher/store">
                        ...
                        <table class="table table-bordered text-center">
                            ...
                            @foreach($usersUnPivot as $user)
                                <tr>
                                    <td>
                                        <input type="checkbox" class="unCheckUsers" name="teacher[]" value="{{ $user->id }}">
                                    </td>
                                    <td>{{ $user->id }}</td>
                                    <td>{{ $user->name }}</td>
            ...
            <div class="contentpanel">
                <div class="panel-body">
                    <form method="POST" action="/exams/{{ $id }}/teacher/update">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <p>已关联教师</p>
                        <table class="table table-bordered text-center">
                            <tr>
                            ...
                            @foreach($usersPivot as $user)
                                <tr>
                                    <td>
                                        <input type="checkbox" class="checkUsers" name="teacher[]" value="{{ $user->id }}">
                                    </td>
                                    <td>{{ $user->id }}</td>
                                    <td>{{ $user->name }}</td>
                                    <td>{{ $user->department->department }}</td>
